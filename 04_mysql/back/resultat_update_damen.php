...
$updates = mysql_query("update SPIELPLAN_DAMEN set resultat = '$res1:$res2' where id = $jahr$monat$tag");

if (!$updates) {
    die('Ungültige Updates: ' . mysql_error());
}
else {
echo "update spielplan_damen set resultat = '",$res1,":",$res2,"' where id = " ,$jahr,$monat,$tag,";","<br>"; 
